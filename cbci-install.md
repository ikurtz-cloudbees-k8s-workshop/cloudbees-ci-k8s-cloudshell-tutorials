...
gcloud container clusters create "ikurtz" \
    --region "us-east1" \
...
CBCI_HOSTNAME=ikurtz.workshop.cb-sa.io
...
The Operations Center for your CloudBees CI cluster should be running or starting up, and available at: [http://ikurtz.workshop.cb-sa.io]/cjoc](http://ikurtz.workshop.cb-sa.io]/cjoc])
